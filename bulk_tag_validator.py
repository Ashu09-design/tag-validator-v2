...
MARKETING_PIXELS = {
    ...
    "Adobe Audience Manager": ["demdex.net/event", "demdex.net/ibs"],
    "DoubleVerify": ["tps.doubleverify.com", "cdn.doubleverify.com"],
    "IAS (Integral Ad Science)": ["pixel.adsafeprotected.com",
    ...
    "Drift": ["js.driftt.com", "js.driftcdn.com", "event.api.drift.com",
    ...
    "Adobe Marketo Engage": [".marketo.com/rs/",
                              "tracker.marketo.com"],
    "Salesforce DMP / Krux": ["beacon.krxd.net", "cdn.krxd.net"],
    "Optimizely": ["cdn.optimizely.com", "logx.optimizely.com",
                    "/event/?a="],
    "Mouseflow": ["cdn.mouseflow.com", "n1.mouseflow.com",
                   "api-eu.mouseflow.com"],
    "Hotjar (Marketing)": ["script.hotjar.com", "static.hotjar.com",
                            "insights.hotjar.com"],
    "Lucky Orange": ["cs.luckyorange.net", "settings.luckyorange.net"],
    "Crazy Egg": ["script.crazyegg.com", "tracking.crazyegg.com"],
    "Sprig (UserLeap)": ["api.sprig.com", "cdn.sprig.com",
                          "cdn.userleap.com"],
    "Intercom": ["api-iam.intercom.io", "widget.intercom.io",
                  "js.intercomcdn.com"],
    "Qualified": ["api.qualified.com", "cdn.qualified.com"],
